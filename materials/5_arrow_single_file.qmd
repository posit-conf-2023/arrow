...
nyc_taxi_2019_09_df <- read_parquet(parquet_file)
nyc_taxi_2019_09_df
```
...
nyc_taxi_2019_09_table <- read_parquet(parquet_file, as_data_frame = FALSE)
nyc_taxi_2019_09_table
```
...
mtcars_table <- arrow_table(mtcars_df)

mtcars_tibble <- as_tibble(mtcars_table)
```
