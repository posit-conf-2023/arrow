...
## [tidyr](https://tidyr.tidyverse.org/) functions - pivot with [duckdb](https://duckdb.org/docs/api/r.html)!
...
-   Working with an Arrow Dataset allows you to manipulate data which is larger-than-memory
